...
builder.Services.AddScoped<IDocumentsDatabaseInitializer, DocumentsDatabaseInitializer>();
...
{
    var initializer = scope.ServiceProvider.GetRequiredService<IDocumentsDatabaseInitializer>();
